...
산출 (lung_pilot/umap_output/):
  per_slide_<slide>.png      — 한 슬라이드의 3 rep UMAP, color = dominant cell-type lineage
  cross_slide_combined.png   — 3 슬라이드 합쳐 3 rep UMAP, color = slide (batch effect 확인)
...
Representations:
  ...
  features_resnet  — features_resnet.npy [N,512] (ResNet18 backbone 순수 visual, graph 미포함)

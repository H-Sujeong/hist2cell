> **Notion 업로드용 패키지** — 이 폴더의 `findings.md` 와 PNG 15장이 같은 디렉토리에 함께 있습니다. Notion 의 `File > Import > Markdown & CSV` 로 zip 째 업로드하면 이미지가 자동 inline 첨부됩니다. 원본 (subfolder 분리된 cell_typing/ + proteomics/ + 원본 CSV) 은 `inference/analysis_spatial/1_085_12/findings.md` 참고.
>
> ⚠️ 본 분석은 **lung-trained Hist2Cell** 모델 결과 + **ROI proteomics gg_matrix** 의 cross-modality 정량 검증. 방법론 / proxy 의미:
> - `inference/analysis_spatial/EPITHELIAL_PROXY_METHODOLOGY.md` (strict / broad epithelial-activity proxy)
> - `inference/analysis_spatial/MORAN_R_METHODOLOGY.md` (80×80 Moran R clustermap 읽는 법, §3.4)
...
![ROI subgraph](section_subgraph.png)
...
![Moran R clustermap — ROI subgraph](moran_r_clustermap.png)
...
![Moran R clustermap — slide-wide](moran_r_clustermap_slide.png)
...
![Immune vs strict vs broad](spatial_immune_vs_epithelial.png)
...
![Section top10](section_top10_celltypes.png)
...
![Section group heatmaps](section_group_heatmaps.png)
...
![Section immune vs epithelial](section_immune_vs_epithelial.png)
...
![Section boxplots](section_boxplots.png)
...
![Section protein summary](section_protein_summary.png)
...
![Volcano — Tumor a vs b](volcano_tumor_a_vs_b.png)
...
![Volcano — T-cell c vs d](volcano_tcell_c_vs_d.png)
...
![Top markers heatmap](top_markers_heatmap.png)
